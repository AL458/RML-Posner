This repository contains the scripts for running the LR analysis for the Posner task. To run the scripts, the function Run_RML_analysis_full.m can be executed.
This runs the analysis for each participant separately. If supported, the script can run multiple instances of Matlab in parallel to speed up the gradient descent. 
